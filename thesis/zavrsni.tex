...
Ovisno o konkretnoj igri, resursi mogu biti drvo, minerali, nafta, zlato, itd. Oni se tipično skupljaju sa posebnom vrstom jedinica zvanom radnicima, te se koriste za izgradnju novih jedinica, zgrada, radnika, itd. 
Resursi također igraju veliku ulogu u strategij same igre. 
Primjerice, ako se igrač nalazi u situacij gdje ne može dalje napredovat zbog manjka nekog resursa, biti će prisiljen otići u potragu za istim. 
...
\par Posljedni bitni element igara u RTS žanru su jedinice. 
...
\par Tokom igre, igrač mora odlučiti u koje će jedinice i tehnologije ulagat te koje će naredbe zadatati pojedinim jedinicama, odnosno koga napast, gdje se pozicionirat, kako ih grupirat, itd. 
Kao posljedica toga, imati dobru strategiju je centralni aspekt igara u RTS žanru. 

\par Također, ključno je imati na umu da će pojedine strategije samo funkcionirati protiv pojedinih protivnika i da određene situacije mogu zahtijevati promjenu strategije. 
...
The literature that was used must be cited along with the recieved help.
