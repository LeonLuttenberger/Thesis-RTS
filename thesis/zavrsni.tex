...
Također, u borbi je poželjno se jedinice nastoje pozicionirati na maksimalnoj udaljenosti od mete na kojoj i dalje mogu pucati, kao što se može vidjeti na slici~\ref{fig:boids}.

\begin{figure}[h]
	\centering
	\includegraphics[width=0.5\linewidth]{images/boids.png}
	\caption{Pozicioniranje jedinica na maksimalnoj udaljenosti od mete}
	\label{fig:boids}
\end{figure}

\subsection{Algoritam Boids}
...
Ovakav rezultat nije prihvaljiv s obzirom na očekivanje da će grupa jedinica biti jača i efikasnija od same jednice.
...
Algoritam koji primjenjuje osnovno ideje ponašanja jata ptica i primjenjuje ih na ostale probleme zove se Boids, što dolazi iz engl. \textit{bird-like objects}, odnosno \textit{bird-oids}.
