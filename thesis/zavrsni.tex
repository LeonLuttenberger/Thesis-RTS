...
''\textit{Šefovi}'' generalno predstavljaju vođe protivničkih skupina, i kompleksniji su i teži protivnici koji se pojavljuju na kraju svakog levela ili sekcije nakon što igrač porazi mnogo slabijih protivnika.
...
Ta ista igre se zatim može učitati i nastaviti bilo kada, odabirom prikladne mogućnosti u početnom ekranu.
...
\par Budući da se u računalnim igrama nastoji što vjernije postići dojam stvarnog okruženja, u današnje doba većina njih predstavlja složene računalne programe, vrlo zahtjevne naspram računalnih resursa koje intenzivno koriste.
...
\par Programeri računalnih igara su pred stalnim stručnim izazovima, uz zahtjeve za kreativnost i posebnost.
Algoritmi RTAA* i \textit{Boids} su na elegantan način riješili probleme kretanja i grupiranja jedinica u RTS igri.

\par Tijekom razvoja konkretne implementacije RTS igre, naglasak je bio na modularnost pojedinih podsustava igre.
Osim što omogućava ponovno iskorištavanje, modularnost podsustava također omogućava jednostavnu nadogradnju i daljini razvoj.
