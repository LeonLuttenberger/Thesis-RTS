...
\par Radnja je smještena tokom povijesti, gdje igrač mora izgraditi i unaprijediti vlastitu civilizaciju.
...
Igrač započinje igru sa nekoliko seljaka s kojima mora skupljati resurse kako bi gradio nove jedinice, proširivao selo i istraživao nove tehnologije.
...
Algoritam na početku obavi pretragu A* sa maksimalnim brojem stanja za posjetiti, te kao rezultat dobije stanje koje je bilo iduće i prioritetnom redu i skup posjećenih stanja.
...
U tom slučaju, petlja započinje ponovo sa izvođenjem pretrage A*.
